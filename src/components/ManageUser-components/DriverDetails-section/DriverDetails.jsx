...
function DriverDetails() {
  ...
  const handleSaveChanges = () => {
    ...
    setIsEditing(false);
    localStorage.setItem(`driver_${id}`, JSON.stringify(updatedDriver));
    handleShow(); 
  };
      ...
      <div className="driver-info-content">
        ...
        {isEditing && (
          <Button
            ...
            style={{ borderRadius: "50px", width: "5rem", marginTop: "2rem", marginRight: "30rem" }}
          >
            บันทึก
          </Button>
        )}
